...
app.get('/images/logo/top-donors.png', function(req, res, next){res.sendFile(path.join(__dirname, 'images/logo', 'top-donors.png'));});
app.get('/images/home/crowd.png', function(req, res, next){res.sendFile(path.join(__dirname, 'images/home', 'crowd.png'));});
app.get('/images/home/jose.png', function(req, res, next){res.sendFile(path.join(__dirname, 'images/home', 'jose.png'));});
app.get('/images/home/vendor.png', function(req, res, next){res.sendFile(path.join(__dirname, 'images/home', 'vendor.png'));});
app.get('/images/home/presenter.png', function(req, res, next){res.sendFile(path.join(__dirname, 'images/home', 'presenter.png'));});
app.get('/images/flags/mexico.png', function(req, res, next){res.sendFile(path.join(__dirname, 'images/flags', 'mexico.png'));});
...
app.get('/images/home/keynote.png', function(req, res, next){res.sendFile(path.join(__dirname, 'images/home', 'keynote.png'));});
